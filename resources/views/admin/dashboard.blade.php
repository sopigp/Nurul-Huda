								...
								<div class="card">
									...
									<div class="card-body loadmore-content height620 dlab-scroll  pb-0" id="RecentActivitiesContent">
										<div class="border-bottom pb-4 mb-4">
											...
											<p class="font-w600"><a href="post-details.html" class="text-black">Visual Graphic for Presentation to Client</a></p>
											<div class="row justify-content-between">
												<ul class="users col-6">
													<li><img src="{{url('admin/images/users/1.jpg')}}" alt=""></li>
													<li><img src="{{url('admin/images/users/2.jpg')}}" alt=""></li>
													<li><img src="{{url('admin/images/users/3.jpg')}}" alt=""></li>
													<li><img src="{{url('admin/images/users/4.jpg')}}" alt=""></li>
												</ul>
										...
										<div class="border-bottom pb-4 mb-4">
											...
											<p class="font-w600"><a href="post-details.html" class="text-black">Build Database Design for Fasto Admin v2</a></p>
											<div class="row justify-content-between">
												<ul class="users col-6">
													<li><img src="{{url('admin/images/users/5.jpg')}}" alt=""></li>
													<li><img src="{{url('admin/images/users/6.jpg')}}" alt=""></li>
													<li><img src="{{url('admin/images/users/7.jpg')}}" alt=""></li>
													<li><img src="{{url('admin/images/users/8.jpg')}}" alt=""></li>
												</ul>
												<div class="col-6 pl-0">
													<h6 class="fs-14">Progress
										...
										<div class="border-bottom pb-4 mb-4">
											...
											<p class="font-w600"><a href="post-details.html" class="text-black">Make Promotional Ads for Instagram Fasto’s</a></p>
											<div class="row justify-content-between">
												<ul class="users col-6">
													<li><img src="{{url('admin/images/users/9.jpg')}}" alt=""></li>
													<li><img src="{{url('admin/images/users/10.jpg')}}" alt=""></li>
													<li><img src="{{url('admin/images/users/11.jpg')}}" alt=""></li>
													<li><img src="{{url('admin/images/users/12.jpg')}}" alt=""></li>
												</ul>
												<div class="col-6 pl-0">
													<h6 class="fs-14">Progress
									...
									<div class="card-footer">
										<a href="javascript:void(0)" class="btn d-block btn-primary light dlab-load-more"   rel="ajax/recent-activities.html" id="RecentActivities"><strong>26</strong> Tasks More</a>
									</div>
								</div>
							</div>
							<div class="col-xl-6 col-xxl-12 col-md-6">
									...
									<div class="card-body">
										<div class="media mb-4">
											<div class="image-bx mr-sm-4 mr-2">
												<img src="{{url('admin/images/users/1.png')}}" alt="" class="rounded-circle img-1">
										...
										<div class="media mb-4">
											<div class="image-bx mr-sm-4 mr-2">
												<img src="{{url('admin/images/users/2.png')}}" alt="" class="rounded-circle img-1">
												<span class="active"></span>
											</div>
											<div class="media-body d-sm-flex justify-content-between d-block align-items-center">
												<div class="mr-sm-3 mr-0">
										...
										<div class="media">
											<div class="image-bx mr-sm-4 mr-2">
												<img src="{{url('admin/images/users/3.png')}}" alt="" class="rounded-circle img-1">
											</div>
											<div class="media-body d-sm-flex justify-content-between d-block align-items-center">
												<div class="mr-sm-3 mr-0">
