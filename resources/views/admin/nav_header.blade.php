...
<div class="nav-header">
            <a href="/administratorx_dashboard" class="brand-logo">
                <img class="logo-abbr" src="{{url('/admin/images/logo.png')}}" alt="">
                <img class="logo-compact" src="{{url('/admin/images/logo-text.png')}}" alt="">
                <img class="brand-title" src="{{url('/admin/images/logo-text.png')}}" alt="">
            </a>
