                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    <form action="{{url('/administratorx_guru/update')}}/{{$guru->id_guru}}" method="post" enctype="multipart/form-data" >
                                        {{ csrf_field() }}
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="nama_lengkap" placeholder="" required="required" value="{{$guru->nama_lengkap}}">
                                                    </div>
                                                </div>
                                                 <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="tempat_lahir" placeholder="" required="required" value="{{$guru->tempat_lahir}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="date" class="form-control" name="dob" placeholder="" required="required" value="{{$guru->dob}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="jenis_kelamin" placeholder="" required="required" value="{{$guru->jenis_kelamin}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="number" class="form-control"  name="nik" placeholder="" required="required" value="{{$guru->nik}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="number" class="form-control" name="no_kk" placeholder="" required="required" value="{{$guru->no_kk}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="number" class="form-control" name="no_npwp" placeholder="" required="required" value="{{$guru->no_npwp}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control"  name="pendidikan" placeholder="" required="required" value="{{$guru->pendidikan}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="date" class="form-control"  name="tgl_masuk_kerja" placeholder="" required="required" value="{{$guru->tgl_masuk_kerja}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="alamat" placeholder="" required="required" value="{{$guru->alamat}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                               ...
                                               <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-8 ml-auto">
                                                        ...
                                                        <a href="{{url('/administratorx_guru')}}" class="btn btn-danger">Kembali</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
